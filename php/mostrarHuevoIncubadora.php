...
$query = "SELECT * FROM incubadora, agregar_huevo, ver_incubadora WHERE incubadora.valido = true AND incubadora.idincubadora = agregar_huevo.idincubadora AND incubadora.idincubadora = ver_incubadora.idincubadora ORDER BY incubadora.idincubadora;";
