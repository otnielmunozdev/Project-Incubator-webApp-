...
$query = "SELECT * FROM sensor, tipo_sensor, registro_sensor WHERE sensor.valido=true AND tipoSensor='".$tipoSensor."' AND sensor.idSensor=tipo_sensor.idSensor AND tipo_sensor.idTipoSensor = registro_sensor.idTipoSensor ORDER BY sensor.idSensor;";
