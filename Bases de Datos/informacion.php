...
<body>
    ...
    <script type="text/javascript">
	 ...
	 function drawChart() {
	   ...
	   var JSON=$.ajax({url:"DatosSensores.php?codigo=" + <?php print $_GET['codigo'];?>,
	   dataType:'json',
	   async: false}).responseText;
	   var Respuesta = jQuery.parseJSON(JSON);
           
           console.log(Respuesta.Informacion[0].tipoHuevo);
		 data.setValue(0, 1, Respuesta.Informacion[1].registro);
		 data.setValue(1, 1, Respuesta.Informacion[0].registro);
		 data.setValue(2, 1, Respuesta.Informacion[0].rangoHuevoMax);
		 data.setValue(3, 1, Respuesta.Informacion[1].rangoHuevoMax);
...
Highcharts.chart('Estadisticas', {
    ...
    series: [{
        name: 'Tiempo',
        data: DatosRecuperados.Estadistica
    }]
});
}});
...
setInterval(function(){
	$.get("DatosSensoresEstadisticas.php?codigo="+<?php $codigo = $_GET['codigo']; print $codigo;?>, function(UltimosDatos){
        ...
        console.log(UltimosDatos[0].x);
        console.log(UltimosDatos[0].y);
